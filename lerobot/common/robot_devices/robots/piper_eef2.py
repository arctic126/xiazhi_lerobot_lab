...
from lerobot.common.robot_devices.teleop.piper_leader_eef_abs import PiperLeader
...
from lerobot.common.robot_devices.robots.configs import PiperEef2RobotConfig

class PiperEef2Robot:
    def __init__(self, config: PiperEef2RobotConfig | None = None, **kwargs):
        if config is None:
            config = PiperEef2RobotConfig()
