...
from lerobot.common.robot_devices.robots.configs import PiperEef1RobotConfig

class PiperEef1Robot:
    def __init__(self, config: PiperEef1RobotConfig | None = None, **kwargs):
        if config is None:
            config = PiperEef1RobotConfig()
