...
from lerobot.common.robot_devices.robots.configs import PiperEefRobotConfig, PiperEef1RobotConfig, PiperEef2RobotConfig

class PiperLeader:
    def __init__(self, config: PiperEefRobotConfig | PiperEef1RobotConfig | PiperEef2RobotConfig):
        # 初始化机械臂接口
